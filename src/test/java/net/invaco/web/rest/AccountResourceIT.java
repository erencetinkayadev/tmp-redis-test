...
import static net.invaco.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import net.invaco.IntegrationTest;
import net.invaco.config.Constants;
import net.invaco.domain.User;
import net.invaco.repository.AuthorityRepository;
import net.invaco.repository.UserRepository;
import net.invaco.security.AuthoritiesConstants;
import net.invaco.service.UserService;
import net.invaco.service.dto.AdminUserDTO;
import net.invaco.service.dto.PasswordChangeDTO;
import net.invaco.service.dto.UserDTO;
import net.invaco.web.rest.vm.KeyAndPasswordVM;
import net.invaco.web.rest.vm.ManagedUserVM;
